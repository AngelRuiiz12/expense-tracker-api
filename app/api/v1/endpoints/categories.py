...
def create_category(data: CategoryCreate, db: DbSession) -> Category:
    exists_category = category_crud.get_category_by_name(db, data.name)
...
def read_category(category_id: int, db: DbSession) -> Category:
...
def patch_category(category_id: int, data: CategoryUpdate, db: DbSession) -> Category:
    category = category_crud.get_category(db, category_id)
